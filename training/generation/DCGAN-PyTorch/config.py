...
if mode == "train":
    # Configure dataset.
    dataset_dir           = "/media/alexey/HDDDataDIsk/datasets/RetinalVesselSegmentation/CompetitionDataset/generation/A2BGeneration/single_class_gan_dataset/"                      # The address of the training dataset.
    image_size            = 64                          # Generator image size.
    ...
    resume_d_weight       = "/home/alexey/programming/squanch_work/RetinalVesselSegmentation/Generation/third_patry/DCGAN-PyTorch/samples/exp000/d_epoch71.pth"                          # Restore the weight of the discriminator model during training.
    resume_g_weight       = "/home/alexey/programming/squanch_work/RetinalVesselSegmentation/Generation/third_patry/DCGAN-PyTorch/samples/exp000/g_epoch71.pth"                          # Restore the weight of the generator model during training.
