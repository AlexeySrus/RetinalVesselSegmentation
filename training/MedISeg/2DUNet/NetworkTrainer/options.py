...
class Options:
    ...
    def parse(self):
        ...
        parser.add_argument('--input-size', type=list, default=[512, 512], help='input size of the image')
        ...
        self.task = args.task
        self.fold = args.fold
        self.root_dir = '/media/alexey/HDDDataDIsk/datasets/RetinalVesselSegmentation/CompetitionDataset/segmentation_representation/'
        self.result_dir = '../' + f'/Experiment/EYEDataset_512/{self.dataset}/'
